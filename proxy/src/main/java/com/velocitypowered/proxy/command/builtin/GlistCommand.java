...
public class GlistCommand {
  ...
  public void register() {
    LiteralCommandNode<CommandSource> totalNode = LiteralArgumentBuilder
            ...
            .requires(source ->
                    source.getPermissionValue("velocity.cmd.glist") == Tristate.TRUE)
  ...
  private int totalCount(final CommandContext<CommandSource> context) {
    ...
    source.sendMessage(Identity.nil(),
        Component.translatable("velocity.cmd.glist-view-all", NamedTextColor.YELLOW));
    return 1;
  }
  ...
  private void sendTotalProxyCount(CommandSource target) {
    ...
    TranslatableComponent msg = online == 1
        ? Component.translatable("velocity.cmd.glist-player-singular")
        : Component.translatable("velocity.cmd.glist-player-plural");
